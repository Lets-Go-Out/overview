...
import { Row, Col, Well, Thumbnail, Media } from "react-bootstrap/lib";
...
const Details = props => {
  ...
  for (let i = 0; i < props.restaurant.tags.length; i += 1) {
    tagsJsx.push(
      <span key={i} styleName="styles.additional_tag">{`${
        props.restaurant.tags[i]
      }, `}</span>
    );
  }
          ...
          <Row>
            ...
            <Col styleName="styles.ALTags" md={6}>
              ...
              <Row>
                ...
                <Media>
                  <Media.Left>{getGlyph("Additional Tags")}</Media.Left>
                  <Media.Body>
